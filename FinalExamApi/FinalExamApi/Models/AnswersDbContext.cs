...
public partial class AnswersDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            //        => optionsBuilder.UseSqlServer("SERVER=JUANJOSECHA; DATABASE=AnswersDb; Trusted_Connection=True; TrustServerCertificate =True; INTEGRATED SECURITY=FALSE; USER ID=ExamUserApi; PASSWORD=1234");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AskStatusId).HasName("PK__AskStatu__0329362C7B3AC65D");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__10D160BF3B8D8B4D");
        ...
        {
            entity.HasKey(e => e.Idconfig).HasName("PK__General__3E2AEF2A85949970");
        ...
        {
            entity.HasKey(e => e.LikeId).HasName("PK__Like__A2922CF434CEB4A5");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACE5E2E092");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A5526390466");
        ...
        {
            entity.HasKey(e => e.UserStatusId).HasName("PK__UserStat__A33F541A86B59AB5");
